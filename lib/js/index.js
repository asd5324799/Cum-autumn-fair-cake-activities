...
var $rankButton = $('.main-page .button-list .center');
...
var $rankRecord = $('.rank-record-page');
var $recordButton = $('.main-page .button-list .right');
var $recordClose = $('.rank-record-page .header .icon');
var $sharePage = $('.main-page .share');
var $shareButton = $('.main-page .button-list .left');
var $shareClose = $('.main-page .share .header .icon');
var $dice = $('.dice');
...
$recordButton.on('click', function () { 
  pageSwitch($mainPage, $rankRecord);
  reset();
});
// 积分说明关闭
$recordClose.on('click', function () { 
  pageSwitch($rankRecord, $mainPage) 
});
// 分享显示
$shareButton.on('click', function() {
  $sharePage.addClass('show');
})
// 分享关闭
$shareClose.on('click', function() {
  $sharePage.removeClass('show');
})
// 博饼动画
